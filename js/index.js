...
//         var toggleTarget = [$(".arrow-wrap"),$(".filters")];
//         $(".icon-shaixuan").click(function(e){
//             if(!filterSwitch){
//                 $("#inputText").removeClass("no-border");
//                 $(".icon-shaixuan").addClass("icon-cuowu");
//                 toggleTarget.forEach(function(target){
//                     target.show();
//                 });
//             }else{
//                 $("#inputText").addClass("no-border");
//                 $(".icon-shaixuan").removeClass("icon-cuowu");
//                 toggleTarget.forEach(function(target){
//                     target.hide();
//                 });
//             }
...
//             $(".select-content").text(content).attr("data-value",value);
//         });
...
S.UI = (function () {
  var input = document.querySelector('.ui-input'),
      ...
      confirmBtn = document.querySelector('#indexConfirm'),
  ...
  function performAction(value) {
    ...
    timedAction(function (index) {
      ...
      switch (action) {
        ...
        default:
          S.Shape.switchShape(S.ShapeBuilder.letter(current[0] === cmd ? '我在等你' : current));
      }
  ...
  function bindEvents() {
    ...
    //bind form confirm event
    confirmBtn.addEventListener('click',function(e){
        var gender = document.getElementById('gender').value;
        var filterWords = document.getElementById('filterWords').value;
        overlay.classList.remove('overlay--visible');
        if(!gender && !filterWords){
            return;
        }

        S.formData = S.formData || {};
        gender && (S.formData.gender = gender);
        filterWords && (S.formData.filterWords = filterWords);
    ...
    //this bind canvas event to close form
  ...
  function displayName(){
    var gender = S.formData && S.formData.gender;
    var filterWords = S.formData && S.formData.filterWords;
    ...
    var name = cwli.NAMES.filterNames(key,gender,filterWords);
    performAction(name);
...
S.Dot = function (x, y) {
  ...
  // this.c = new S.Color(255, 165, 0, this.p.a);
